...
def argparser():
	...
	argparser.add_argument('--vocab', '-v', required=False, help="path to existing vocab file")
...
if __name__ == '__main__':
	...
	data_train = pd.read_csv(args.input_file, sep='\t', keep_default_na=False).reset_index(drop=False)
